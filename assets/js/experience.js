...
const experience = [
  {
    ...
    duration: "present",
    location: "Dallas, TX",
    code: "bcrypt css express javascript sql mysql sequelize node react",
    description: [
      "Building an MVC app for company's clients and employees.",
      "Express routing server endpoints to facilitate frontend & backend communication.",
      "Writing great copy for a financial planner.",
      // "Using ORM and custom SQL queries to join tables.",
    ],
